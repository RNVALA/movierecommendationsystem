...
simillarity = pickle.load(open('similarity.pkl','rb'))
...
selected_movies_name = st.selectbox('for which movie you want to find recommandation?',
                      (movies_list1))
if st.button('press button for recommendation'):
